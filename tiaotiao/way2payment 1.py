...
health_state = ['admiss_diag', 'admiss_times', 'dis_diag_no', 'dis_diag', 'dis_diag_type', 'dis_diag_status',
                'admiss_status']
...
if __name__ == '__main__':
    ...
    subsample = {'shifu_all': shifu_all, }

    for shifu_subsample in [shifu_all, shifu_DIH_leq_14, shifu_DIH_gt_14]:
        for attribute in [payment, personal_information, health_state, all]:
            tiaotiao(shifu_subsample[attribute])
